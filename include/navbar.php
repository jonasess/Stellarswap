...
<!-- Menu -->			  
	<!-- Menu -->
		<nav id="menu">
			...
			<ul>
				<li><a href="stellarSwap-wallet.php">Balance</a></li>
				<li><a href="stellarSwap-sendpayments.php">Send payments</a></li>
				<li><a href="stellarSwap-acceptAsset.php">Accept asset</a></li>
